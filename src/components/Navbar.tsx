...
import { Camera, Swords, BookOpen, FlaskConical, Volume2, VolumeX, Shield, Atom, Layers } from 'lucide-react';
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5">
            ...
            <div className="flex items-center gap-1.5 bg-cyan-950/60 border border-cyan-500/40 px-2.5 sm:px-3 py-1.5 rounded-xl text-xs font-mono">
              ...
              <span className="font-extrabold text-cyan-300">{unlockedCount}/118</span>
